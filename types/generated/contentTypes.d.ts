...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Headline_image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.Required;
...
export interface ApiCompletedEventCompletedEvent extends Schema.CollectionType {
  collectionName: 'completed_events';
  info: {
    singularName: 'completed-event';
    pluralName: 'completed-events';
    displayName: 'Completed Event';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    Poster: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::completed-event.completed-event',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    Headline: Attribute.String;
    Shortdescription: Attribute.String;
    Date_of_the_event: Attribute.Date;
...
export interface ApiNewsAndPrNewsAndPr extends Schema.CollectionType {
  collectionName: 'news_and_prs';
  info: {
    singularName: 'news-and-pr';
    pluralName: 'news-and-prs';
    displayName: 'News & PR';
    description: '';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::completed-event.completed-event': ApiCompletedEventCompletedEvent;
      'api::event.event': ApiEventEvent;
      'api::news-and-pr.news-and-pr': ApiNewsAndPrNewsAndPr;
    }
  }
}
